configuration ConfigureSPVM
{
    ...
    [String] $DomainNetbiosName = (Get-NetBIOSName -DomainFQDN redetjsp.local)
    $Interface = Get-NetAdapter| Where-Object Name -Like "Ethernet*"| Select-Object -First 1
    $InterfaceAlias = $($Interface.Name)
    [System.Management.Automation.PSCredential] $DomainAdminCredsQualified = New-Object System.Management.Automation.PSCredential ("${DomainNetbiosName}\tjsp.sp", Y2Z5nyekGFwcaFNC)
