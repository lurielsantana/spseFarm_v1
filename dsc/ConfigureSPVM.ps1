configuration ConfigureSPVM
{
    ...
    [System.Management.Automation.PSCredential] $DomainAdminCredsQualified = New-Object System.Management.Automation.PSCredential ("redetjsp.local\tjsp.sp", Y2Z5nyekGFwcaFNC)
